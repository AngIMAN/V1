...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}------------------------------------------------------------${NC}"
echo -e "  EDIT BY : ${green}VPN EXPRESS${NC}"
echo -e "${YELLOW}------------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/AngIMAN/V1/main/"
...
function pasang_domain() {
    ...
    while true; do
        echo -e "\e[1;33m-------------------------------------------------\e[0m"
        echo -e "   \e[1;34m     Please Select a Domain Type Below\e[0m"
        echo -e "\e[1;33m-------------------------------------------------\e[0m"
        ...
        if [[ $host == "1" ]]; then
            ...
            echo -e "\e[1;36m   Installing random subdomain...\e[0m"
            wget -q ${REPO}files/cf && chmod +x cf && ./cf
            rm -f /root/cf
            clear
            echo -e "\e[1;32m   Random subdomain successfully set!\e[0m"
            break
        else
            echo -e "\e[1;31m   Invalid choice! Please select either 1 or 2.\e[0m"
            echo -e "\e[1;33m-------------------------------------------------\e[0m"
        fi
    done
}
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/AngIMAN/izinvps/main/ip"
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/628981874211"}]]}' 
...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/AngIMAN/V1/main/config/rclone.conf"
cd /bin
